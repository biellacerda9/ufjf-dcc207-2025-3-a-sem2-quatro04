...
export default function MedicationCard({ nome, dosagem, horario, status, apenasPendentes = false, isEditingMode}: MedicationCardProps) {
  ...
  const buttonDelete = isEditingMode ? (
